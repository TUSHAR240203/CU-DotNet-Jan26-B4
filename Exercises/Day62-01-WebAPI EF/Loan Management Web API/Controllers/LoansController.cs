...
namespace Loan_Management_Web_API.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class LoansController : ControllerBase
    {
        private readonly Loan_Management_Web_APIContext _context;

        public LoansController(Loan_Management_Web_APIContext context)
        {
            _context = context;
        }
